...
TESS_API struct Boxa *
        TESS_CALL TessBaseAPIGetTextlines1(TessBaseAPI *handle, const BOOL raw_image,
...
TESS_API BOOL  TESS_CALL TessBaseAPIProcessPage(TessBaseAPI *handle, struct Pix *pix,
...
TESS_API struct Pix *
        TESS_CALL TessPageIteratorGetImage(const TessPageIterator *handle,
...
TESS_API const char *
        TESS_CALL TessResultIteratorWordFontAttributes(const TessResultIterator *handle,
                                                       BOOL *is_bold, BOOL *is_italic,
                                                       BOOL *is_underlined, BOOL *is_monospace,
                                                       BOOL *is_serif,
                                                       BOOL *is_smallcaps, int *pointsize,
                                                       int *font_id);

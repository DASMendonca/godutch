...
TESS_API BOOL TESS_CALL TessBaseAPISetVariable(TessBaseAPI *handle, const char *name,
                                               const char *value) {
    return handle->SetVariable(name, value) ? TRUE : FALSE;
}

TESS_API BOOL TESS_CALL TessBaseAPISetDebugVariable(TessBaseAPI *handle, const char *name,
                                                    const char *value) {
    return handle->SetVariable(name, value) ? TRUE : FALSE;
}

TESS_API BOOL TESS_CALL TessBaseAPIGetIntVariable(const TessBaseAPI *handle, const char *name,
                                                  int *value) {
    return handle->GetIntVariable(name, value) ? TRUE : FALSE;
}

TESS_API BOOL TESS_CALL TessBaseAPIGetBoolVariable(const TessBaseAPI *handle, const char *name,
                                                   BOOL *value) {
    bool boolValue;
...
TESS_API BOOL TESS_CALL TessBaseAPIGetDoubleVariable(const TessBaseAPI *handle, const char *name,
                                                     double *value) {
...
TESS_API BOOL TESS_CALL TessBaseAPIGetVariableAsString(TessBaseAPI *handle, const char *name,
                                                       STRING *val) {
    return handle->GetVariableAsString(name, val) ? TRUE : FALSE;
}

TESS_API int TESS_CALL TessBaseAPIInit4(TessBaseAPI *handle, const char *datapath,
                                        const char *language,
...
TESS_API int TESS_CALL TessBaseAPIInit1(TessBaseAPI *handle, const char *datapath,
...
TESS_API int TESS_CALL TessBaseAPIInit2(TessBaseAPI *handle, const char *datapath,
                                        const char *language, TessOcrEngineMode oem) {
    return handle->Init(datapath, language, oem);
}

TESS_API int TESS_CALL TessBaseAPIInit3(TessBaseAPI *handle, const char *datapath,
                                        const char *language) {
...
TESS_API int TESS_CALL TessBaseAPIInitLangMod(TessBaseAPI *handle, const char *datapath,
                                              const char *language) {
...
TESS_API void TESS_CALL TessBaseAPISetImage(TessBaseAPI *handle, const unsigned char *imagedata,
...
TESS_API void TESS_CALL TessBaseAPISetRectangle(TessBaseAPI *handle, int left, int top, int width,
                                                int height) {
...
TESS_API struct Boxa *TESS_CALL TessBaseAPIGetTextlines(TessBaseAPI *handle, struct Pixa **pixa,
                                                        int **blockids) {
    return handle->GetTextlines(pixa, blockids);
}

TESS_API struct Boxa *TESS_CALL TessBaseAPIGetTextlines1(TessBaseAPI *handle, const BOOL raw_image,
...
TESS_API struct Boxa *TESS_CALL TessBaseAPIGetStrips(TessBaseAPI *handle, struct Pixa **pixa,
                                                     int **blockids) {
...
TESS_API struct Boxa *TESS_CALL TessBaseAPIGetComponentImages(TessBaseAPI *handle,
                                                              ...
                                                              BOOL text_only, struct Pixa **pixa,
                                                              int **blockids) {
    return handle->GetComponentImages(level, text_only != FALSE, pixa, blockids);
}

TESS_API struct Boxa *
TESS_CALL TessBaseAPIGetComponentImages1(TessBaseAPI *handle, const TessPageIteratorLevel level,
                                         const BOOL text_only,
                                         const BOOL raw_image, const int raw_padding,
                                         struct Pixa **pixa, int **blockids, int **paraids) {
    return handle->GetComponentImages(level, text_only != FALSE, raw_image, raw_padding, pixa,
                                      blockids, paraids);
}
...
TESS_API BOOL TESS_CALL TessBaseAPIProcessPage(TessBaseAPI *handle, struct Pix *pix, int page_index,
                                               const char *filename,
...
TESS_API BOOL TESS_CALL TessBaseAPIAdaptToWordStr(TessBaseAPI *handle, TessPageSegMode mode,
                                                  const char *wordstr) {
...
TESS_API void TESS_CALL TessBaseAPIGetFeaturesForBlob(TessBaseAPI *handle, TBLOB *blob,
...
TESS_API void TESS_CALL TessBaseAPIRunAdaptiveClassifier(TessBaseAPI *handle, TBLOB *blob,
                                                         int num_max_matches,
...
TESS_API const char *TESS_CALL TessResultIteratorWordRecognitionLanguage(

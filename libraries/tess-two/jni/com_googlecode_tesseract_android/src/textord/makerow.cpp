...
bottom;
if (
testing_blob &&textord_debug_blob
) {
...
backward();         //make it point to row
//doesn't overlap much
if (top - bottom - bestover >
rowsize *textord_overlap_x
&&

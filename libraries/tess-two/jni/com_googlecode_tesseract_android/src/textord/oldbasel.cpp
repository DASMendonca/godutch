 ...
 **********************************************************************/
    ...
    /*average ascenders */
    float minascheight;
    /*min allowed ascheight */
    int xcount;
    /*no of samples for xheight */
    float fullheight;
    /*mean top height */
    int fullcount;
    /*no of samples */
...
if (lineheight > 0.0f)
block->block->
set_cell_over_xheight((fullheight
- descheight) / lineheight);
...
row->
ascrise = row->xheight - lineheight;
/*set to average */
row->
xheight = lineheight;
row->
...
row->
ascrise = (fullheight - lineheight) * row->xheight
          / fullheight;
/*scale it */
row->xheight -= row->
ascrise;
...
row->
descdrop = -row->xheight * DESCENDER_FRACTION;
}
}
return (int)
lineheight;       //block xheight
}

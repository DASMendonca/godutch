 ...
 **********************************************************************/
    ...
    * blob) {
    ...
    if (points[y] &&
    points[x]->
    WeightedDistance(*points[y], chop_x_y_weight
    ) <
    chop_split_length &&
            points[x]
    != points[y]->
...
vertical_projection_point(points[x], outline
->loop,
&vertical_point, new_points);
}

if (
vertical_point &&points[x]
!= vertical_point->
next &&
        vertical_point
!= points[x]->
next &&
        points[x]
->
WeightedDistance(*vertical_point, chop_x_y_weight
) <
chop_split_length) {

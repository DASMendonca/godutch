...
jint Java_com_googlecode_leptonica_android_Box_nativeGetX(JNIEnv *env, jclass clazz,
                                                          jlong nativeBox) {
    BOX *box = (BOX *) nativeBox;
...
jint Java_com_googlecode_leptonica_android_Box_nativeGetY(JNIEnv *env, jclass clazz,
                                                          jlong nativeBox) {
    BOX *box = (BOX *) nativeBox;

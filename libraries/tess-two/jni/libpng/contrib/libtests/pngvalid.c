...
typedef struct png_store {
    ...
    */
    ...
    /* The end of the new PNG file being written. */
...
typedef struct png_modifier {
    ...
    */
    ...
    PNG_CONST color_encoding *current_encoding;
...
#           ifdef PNG_WRITE_FILTER_SUPPORTED
                ...
                */
                            png_set_filter(pp, 0/*method*/,
                                           nfilter >= PNG_FILTER_VALUE_LAST ? PNG_ALL_FILTERS
                                                                            : nfilter);
...
image_transform_default_add(image_transform *this,
                            PNG_CONST image_transform **that, png_byte colour_type,
                            png_byte bit_depth) {
    UNUSED(colour_type)
    UNUSED(bit_depth)
...
image_transform_png_set_expand_gray_1_2_4_to_8_add(image_transform *this,
                                                   PNG_CONST image_transform **that,
...
#  if DIGITIZE
        {
            ...
            const unsigned int gamma_depth = (sample_depth == 16 ? 16 :
                                              (pm->assume_16_bit_calculations ? PNG_MAX_GAMMA_8
                                                                              : sample_depth));
            int isgray;
            double r, g, b;

...
public class SimpleAndroidOCRActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		/*(View v) -> {
			...
			onPhotoTaken("drawable://" + R.drawable.test_image);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == -1) {
            onPhotoTaken(BitmapFactory.decodeResource(getResources(), R.drawable.test_image));
        } else {
    ...
    protected void onPhotoTaken(Bitmap bitmap) {
		...
		try {
			ExifInterface exif = new ExifInterface(myPath);
